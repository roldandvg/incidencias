...
urlpatterns = patterns('',
                       ...
                       url(r'^procedimiento/edit/(?P<pk>\d+)$', views.ProcedimientoUpdate.as_view(),
                           name='procedimiento_edit'),
                       url(r'^procedimiento/delete/(?P<pk>\d+)$', views.ProcedimientoDelete.as_view(),
                           name='procedimiento_delete'),

                       url(r'^tipoprocedimiento/$', views.TipoProcedimientoList.as_view(),
                           name="tipoprocedimiento_list"),
                       url(r'^tipoprocedimiento/new/$', views.TipoProcedimientoCreate.as_view(),
                           name='tipoprocedimiento_new'),
                       url(r'^tipoprocedimiento/edit/(?P<pk>\d+)$', views.TipoProcedimientoUpdate.as_view(),
                           name='tipoprocedimiento_edit'),
                       url(r'^tipoprocedimiento/delete/(?P<pk>\d+)$', views.TipoProcedimientoDelete.as_view(),
                           name='tipoprocedimiento_delete'),

                       url(r'^detalletipoprocedimiento/$', views.DetalleTipoProcedimientoList.as_view(),
                           name="detalletipoprocedimiento_list"),
                       url(r'^detalletipoprocedimiento/new/$', views.DetalleTipoProcedimientoCreate.as_view(),
                           name='detalletipoprocedimiento_new'),
                       url(r'^detalletipoprocedimiento/edit/(?P<pk>\d+)$',
                           views.DetalleTipoProcedimientoUpdate.as_view(), name='detalletipoprocedimiento_edit'),
                       url(r'^detalletipoprocedimiento/delete/(?P<pk>\d+)$',
                           views.DetalleTipoProcedimientoDelete.as_view(), name='detalletipoprocedimiento_delete'),
