...
from incidencias.apps.comun.models import Zona, Municipio, Parroquia, \
Estacion, Procedimiento, TipoProcedimiento, DetalleTipoProcedimiento, \
Unidad, Comision, Diagnostico
